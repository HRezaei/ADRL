...
CUDA_VISIBLE_DEVICES=0 python -u train_babyai_text.py --env_name "BabyAI-MixedTrainLocal-v0" \
 --algorithm_name "POAD" --experiment_name "full_scale" --num_env_steps 6000 --seed 10 \
 --entropy_coef 0.01 --ppo_epoch 1 --num_mini_batch 2 --gradient_cp_steps 16 --model_name ${llama} \
#  --use_full_scale
